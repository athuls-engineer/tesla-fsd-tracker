      ...
      h(
        'div',
        {
          style: {
            ...
            backgroundImage: 'radial-gradient(circle at 85% 15%, rgba(232, 33, 39, 0.22) 0%, transparent 65%)',
            padding: '60px 70px',
        ...
        h(
          ...
          h(
            'svg',
            { width: '160', height: '22', viewBox: '0 0 342 35', fill: '#ffffff' },
            h('path', {
          ...
          h(
            ...
            h(
              'span',
              { style: { fontSize: '18px', fontWeight: 700, color: '#34c759', letterSpacing: '1px' } },
        ...
        h(
          ...
          h(
            'div',
            { style: { fontSize: '20px', fontWeight: 600, color: '#888888', letterSpacing: '3px', textTransform: 'uppercase' } },
          ...
          h(
            ...
            h(
              'span',
              { style: { fontSize: '48px', fontWeight: 800, color: '#e82127', marginLeft: '16px' } },
              unit
            )
          ),
          h(
            'div',
            { style: { fontSize: '22px', color: '#aaaaaa', marginTop: '12px', display: 'flex', alignItems: 'center' } },
            h('span', null, '2M+ Active Autonomous Vehicles'),
            h('span', { style: { margin: '0 12px', color: '#555555' } }, '•'),
            h('span', null, '12 Countries & Territories'),
            h('span', { style: { margin: '0 12px', color: '#555555' } }, '•'),
            h('span', null, 'V12 / V13 Neural Nets')
          )
        ),
        // Bottom block
        h(
          ...
          h(
            'span',
            { style: { fontSize: '20px', fontWeight: 700, color: '#e82127', letterSpacing: '1px' } },
