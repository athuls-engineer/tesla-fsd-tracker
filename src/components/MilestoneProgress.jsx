...
export default function MilestoneProgress({
  ...
  return (
    <section id="milestone" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-neutral-50 dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xs">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200 dark:border-neutral-800/80 pb-6">
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold tracking-wider uppercase text-tesla-red">
                Dynamic Fleet Milestone Engine
              </span>
            </div>
            <div className="flex flex-wrap items-baseline gap-2 mt-2">
              <h3 className="text-2xl sm:text-3xl font-bold font-tesla text-neutral-900 dark:text-white">
          ...
          <div className="flex items-center space-x-2 self-start sm:self-auto">
            {selectedTargetIndex !== null && (
              <button
                ...
                className="text-xs font-semibold px-3 py-2 rounded-lg bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-300 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 transition-colors"
              >
                Back to Current
              </button>
            )}
            <button
              ...
              className="text-xs font-medium px-3.5 py-2 rounded-lg bg-neutral-200/80 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors text-neutral-800 dark:text-neutral-200 flex items-center space-x-1.5"
            >
              <Sparkles size={14} className="text-tesla-red" />
        ...
        <div className="mt-6 flex items-center space-x-1 sm:space-x-2 overflow-x-auto pb-2 scrollbar-none">
          {MILESTONE_ROADMAP.map((m, idx) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all flex items-center space-x-1.5 border ${
                  isSelected
        ...
        {/* Progress Bar Track */}
        <div className="mt-6">
          <div className="flex justify-between items-end mb-2 text-xs sm:text-sm font-semibold">
            <span className="text-neutral-600 dark:text-neutral-300">
              Progress to {activeLabel}: <span className="text-neutral-900 dark:text-white font-mono">{progressPercent.toFixed(3)}%</span>
            </span>
            <span className="text-neutral-600 dark:text-neutral-300">
          ...
          {/* Bar track */}
          <div className="h-5 w-full bg-neutral-200/80 dark:bg-neutral-800 rounded-full overflow-hidden p-0.5 border border-neutral-300/60 dark:border-neutral-700/60 shadow-inner">
            <div
          ...
          <div className="flex justify-between mt-2 text-[11px] text-neutral-400 dark:text-neutral-500 font-medium">
            <span>
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 rounded-xl bg-white dark:bg-black/40 border border-neutral-200 dark:border-neutral-800/80 text-center shadow-xs">
            <span className="text-2xl sm:text-3xl font-extrabold font-tesla text-neutral-900 dark:text-white tabular-nums">
              {countdown.days}
            </span>
            <p className="text-[11px] font-semibold text-neutral-500 dark:text-neutral-400 uppercase mt-1">
              Days
            </p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-black/40 border border-neutral-200 dark:border-neutral-800/80 text-center shadow-xs">
            <span className="text-2xl sm:text-3xl font-extrabold font-tesla text-tesla-red tabular-nums">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between px-4 py-3 rounded-lg bg-neutral-100 dark:bg-neutral-800/50 text-xs text-neutral-600 dark:text-neutral-400 gap-2">
          <div className="flex items-center space-x-2">
            <Calendar size={15} className="text-neutral-500 shrink-0" />
            <span>Projected Arrival at Fleet Velocity:</span>
