...
export default function SafetyComparison({ unit = 'miles' }) {
  ...
  return (
    <section id="safety" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white dark:bg-[#0c0c0c] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xs">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200 dark:border-neutral-800 pb-6">
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold tracking-wider uppercase text-emerald-500">
                Tesla Vehicle Safety Report Benchmark
              </span>
            </div>
            <h3 className="mt-2 text-2xl sm:text-3xl font-bold font-tesla text-neutral-900 dark:text-white">
              7x Safer Than The US National Average⁵
            </h3>
          </div>

          <span className="text-xs font-medium px-3 py-1.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 self-start sm:self-auto font-mono">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-bold text-neutral-900 dark:text-white flex items-center space-x-2">
            ...
            <div className="h-5 w-full bg-neutral-100 dark:bg-neutral-800 rounded-lg overflow-hidden p-0.5">
              <div className="h-full bg-emerald-500 rounded-md transition-all duration-700 w-full relative">
                <span className="absolute right-2 top-0.5 text-[10px] font-bold text-white uppercase tracking-wider">
                  7.4x Safer Benchmark
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-neutral-700 dark:text-neutral-300 flex items-center space-x-2">
            ...
            <div className="h-4 w-full bg-neutral-100 dark:bg-neutral-800 rounded-lg overflow-hidden p-0.5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-neutral-500 dark:text-neutral-400 flex items-center space-x-2">
        ...
        <div className="mt-8 p-3.5 rounded-xl bg-neutral-50 dark:bg-neutral-900/60 border border-neutral-200 dark:border-neutral-800 flex items-start space-x-2.5 text-xs text-neutral-600 dark:text-neutral-400">
        ...
        {/* Safety Pillars Grid */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 border-t border-neutral-200 dark:border-neutral-800">
          <div className="p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/40 border border-neutral-100 dark:border-neutral-800">
